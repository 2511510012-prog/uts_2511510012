<?php
// 1. Tambah proteksi session di baris paling atas (Sesuai PDF 2 Halaman 2 No.4)
session_start();
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <?php if ($_SESSION['role'] == 'admin') { ?>
            ...
            <li class="nav-item"><a href="#" class="nav-link"><i class="nav-icon fas fa-edit"></i><p>Transaksi</p></a></li>
